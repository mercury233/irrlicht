...
#ifndef _C_IMAGE_WRITER_WEBP_H_INCLUDED__
#define _C_IMAGE_WRITER_WEBP_H_INCLUDED__
...
class CImageWriterWEBP : public IImageWriter
{
public:
	//! constructor
	CImageWriterWEBP();
...
#endif // _C_IMAGE_WRITER_WEBP_H_INCLUDED__
